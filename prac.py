...
frame_1.pack(expand=False,side='top',fill='both')
...
def hint():
	...
	frame_2.pack(expand=False,side='top',fill='both')
	global label_hint
...
def func(par):
	...
	score,lives=ob1.read(x,lives_1,score)
	lives_1=lives
	
	if lives<=0:
		print("game over")
		print("score = " +str(ob1.score))			
		sys.exit()
	if score+1==ob1.score:
		if label_hint:
			label_hint.destroy()
			hint()	
...
space=tk.Button(frame,text='space',height=1,width=1,command=lambda :func(" "),padx=20)
